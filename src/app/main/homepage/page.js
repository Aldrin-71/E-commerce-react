      ...
      <section className="collections-section">
        <div className="collections-grid">
          <div className="collection-item large">
            <h3>PRO DECKS</h3>
            <img src="https://phillewisart.com/cdn/shop/products/IMG_0894_1200x.jpg?v=1646926505"/>
            <div className="collection-link"></div>
            <a href="#" className="collection-btn">Shop Now</a>
          </div>
          <div className="collection-item">
            <h3>WHEELS</h3>
            <img src="https://www.tactics.com/a/fdsq/r/wheels-product-shot.jpg"/>
            <div className="collection-link"></div>
            <a href="#" className="collection-btn">Explore</a>
          </div>
          <div className="collection-item">
            <h3>TRUCKS</h3>
             <img src="https://ghostboards.com/wp-content/uploads/2024/05/longboard-vs-skate-trucks-thumbnail.jpg"/>
            <div className="collection-link"></div>
            <a href="#" className="collection-btn">Explore</a>
          </div>
          <div className="collection-item">
            <h3>KIDS GEAR</h3>
            <img src="https://contents.mediadecathlon.com/p2584768/k$9ba7043ee199d5649e0b798a8c1e5846/kids-2-x-3-piece-inline-skating-scooter-skateboard-protective-gear-play-blue-oxelo-8784953.jpg?f=1920x0&format=auto"/>
            <div className="collection-link"></div>
            <a href="#" className="collection-btn">Shop Now</a>
          </div>
          <div className="collection-item">
            <h3>ACCESSORIES</h3>
            <img src="https://www.skatewarehouse.co.uk/cdn/shop/collections/VNM-Tool-kit-21_1200x1200.jpg?v=1750928385"/>
            <div className="collection-link"></div>
            <a href="#" className="collection-btn">Explore</a>
          </div>
        </div>
